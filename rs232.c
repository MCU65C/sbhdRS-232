...
int RS232_OpenComport(int comport_number, unsigned long baudrate, const char *mode, int flowctrl)
{
  int err, status;
  unsigned long baudr;
  ...
  switch(baudrate)
  {
    ...
    case   38400 : baudr = B38400;
                   break;
    case   43200 : baudr = B43200;
                   break;
    case   57600 : baudr = B57600;
                   break;
    case   72000 : baudr = B72000;
                   break;
    case   86400 : baudr = B86400;
                   break;
    case  100800 : baudr = B100800;
                   break;
...
int RS232_OpenComport(int comport_number, int baudrate, const char *mode, int flowctrl)
{
  ...
  switch(baudrate)
  {
    ...
    case   38400 : strcpy(mode_str, "baud=38400");
                   break;
    case   43200 : strcpy(mode_str, "baud=43200");
                   break;
    case   57600 : strcpy(mode_str, "baud=57600");
                   break;
    case   72000 : strcpy(mode_str, "baud=72000");
                   break;
    case   86400 : strcpy(mode_str, "baud=86400");
                   break;
    case  100800 : strcpy(mode_str, "baud=100800");
                   break;
